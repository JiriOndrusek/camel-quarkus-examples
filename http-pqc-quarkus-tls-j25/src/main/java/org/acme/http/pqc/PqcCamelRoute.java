 ...
 * using Quarkus TLS Registry on JDK 25+.
 */
@ApplicationScoped
public class PqcCamelRoute extends EndpointRouteBuilder {
    ...
    private static final String SECURE_RESPONSE = "Secure data delivered via Post-Quantum Cryptography (PQC)!\n\n" +
            ...
            "- Configuration: Quarkus TLS Registry\n" +
            "- JDK: 25+ (native SunJSSE PQC support)\n\n" +
            ...
            "No BouncyCastle JSSE provider needed — JDK 25+ supports PQC natively.";
