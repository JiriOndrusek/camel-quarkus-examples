...
The `jdk.tls.namedGroups` system property controls which key exchange algorithms are available during TLS negotiation. By placing `x25519_mlkem768` first, it becomes the preferred choice when both client and server support it.
...
Configured Named Groups: x25519_mlkem768, x25519, secp256r1, secp384r1, secp521r1
...
1. Server configured named groups (x25519_mlkem768)
